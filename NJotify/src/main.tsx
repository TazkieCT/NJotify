...
import AccountSettingPage from './views/account/AccountSettingPage';
import AdminPage from './views/account/AdminPage';
import LoginForm from './views/auth/LoginForm';
import RegisForm from './views/auth/RegisForm';
import ResetPasswordForm from './views/auth/ResetForm';
import ForgetForm from './views/auth/ForgetForm';
import Activation from './views/auth/Activation';
import Notification from './views/account/Notification';
import GetVerified from './views/account/GetVerified';
